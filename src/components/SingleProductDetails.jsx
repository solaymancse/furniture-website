                    ...
                    <div className="mt-4 lg:row-span-3 lg:mt-0">
                        ...
                        <form className="mt-10">
                            ...
                            <button
                                ...
                                className="mt-10 flex w-full items-center justify-center rounded-md border   px-8 py-3 text-base font-medium text-gray-600 cart focus:outline-none focus:ring-2  focus:ring-offset-2"
                            >
                                Add to Cart
                            </button>
                    ...
                    <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
                        ...
                        <div className="mt-10 flex flex-col gap-4">
                            <div className='flex items-center gap-4  '>
                                ...
                                <span className='text-sm text-gray-400'> SS001</span>
                            </div>
                            <div className='flex items-center gap-4  '>
                                <div className='flex items-center justify-between w-150'>
                                ...
                                <span className='text-sm text-gray-400'> Sofas</span>
                            </div>
                            <div className='flex items-center gap-4  '>
                                <div className='flex items-center justify-between w-150'>
                                ...
                                <span className='text-sm text-gray-400'> Sofa, Chair, Home, Shop</span>
                            </div>
                            <div className='flex items-center gap-4  '>
                                <div className='flex items-center justify-between w-150'>
                                    <p className="text-sm font-medium text-gray-400">Share</p>
                                    <span>:</span>
                                </div>
                                <span className='text-sm text-gray-700 flex gap-4 items-center'>
