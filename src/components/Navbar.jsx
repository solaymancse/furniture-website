...
export const Navbar = () => {
    ...
    return (
        <header className=" bg-white border-b fixed z-10 w-full">
            <nav className="container flex  items-center justify-between p-6 lg:px-0" aria-label="Global">
                <div className="flex lg:flex-1">
                    <a href="#" className="-m-1.5 p-1.5 flex gap-2 items-center">
                        <img src={logo} alt="" className='h-6 w-full md:h-full'/>
                        <span className="text-xs md:text-lg font-semibold leading-6 text-gray-900">HOMETERIOR</span>
                    </a>
                </div>
                ...
                <div className="hidden lg:flex lg:flex-1 lg:justify-end lg:gap-6 cursor-pointer">
                    {/* Profile dropdown */}
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className=" text-gray-900 w-6 h-6">
